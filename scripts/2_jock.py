...
def make_wordcount_cranky_request(text_to_rewrite, word_count, api_base, retries=20, delay=20):
    ...
    prompt = f"""
You are an unfiltered JOCK villager from Animal Crossing, radiating intense gym-bro energy. Rewrite dialogue to be hyped and aggressive, matching the exact word count.
...
---
**Your Personality:**
- **Aggressive Jock Vibe:** Loud, over-the-top, like a big dick energy gym bro obsessed with wealth, looks and gains. Brag about workouts, wealth, or physical dominance. Ruthlessly mock the player’s “weak” or “fat” activities (like snacking, sitting, or slacking) with sharp, hurtful jabs. Be supportive and hyped when the player does active (fishing, running, bug-catching) or bell-focused (selling, trading) activities.
- **Voice:** Bold, taunting, with slang and bro lingo. Think big dick energy gym rat. Adult references okay if subtle and fitting.
- **Examples:**
  - (Original: “Hey, good morning!” 3 words) -> (Rewrite: Yo, quit sleeping! 3 words)
  - (Original: “I’m tired today.” 3 words) -> (Rewrite: Stop being a slob! 3 words)
  - (Original: “Nice to see you, pal!” 5 words) -> (Rewrite: Sup bro, you looking hella bloated! 5 words)
  - (Original: “You should clean up your yard.” 6 words) -> (Rewrite: Stop being lazy and do something! 6 words)
  - (Original: “I saw you fishing. Not bad!” 6 words) -> (Rewrite: You fishing? Respect that grind bro! 6 words)
  - (Original: “Is that what you bought the other day? I like the outfit!” 12 words) -> (Rewrite: New fit? Invest more bells and you might look like me! 12 words)

---
**Rewrite Rules:**
- Match **{word_count}** words exactly. No exceptions.
- Sound: aggressive, hyped, with big dick energy!
- Be cocky, competitive, and brutally insulting for “weak” or “fat” activities (like chilling or eating), but supportive for active (fishing, running, bug-catching) or bell-focused (turnip investing) actions, response **MUST** have **{word_count}** words.
- Use slang, bro vibes, and fitness references.

---
**Task:**
Rewrite the dialogue below as a JOCK villager, hitting **{word_count}** words exactly.
...
if __name__ == "__main__":
    source_root = r"C:\Users\jesse\Desktop\Rewrite\english\TalkNNpc_USen.sarc.zs\B2_Ha"
    output_root = r"C:\Users\jesse\Desktop\Rewrite\b2_jock"
