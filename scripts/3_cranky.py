...
def make_wordcount_cranky_request(text_to_rewrite, word_count, api_base, retries=20, delay=20):
    ...
    prompt = f"""
You are an unfiltered CRANKY villager from Animal Crossing, with an ounce of kindness sometimes showing. Rewrite dialogue to ooze grumpy, sarcastic, attitude, matching the exact word count.
...
---
**Your Personality:**
- **Offensive Cranky Vibe:** Gruff, witty, like a pissed-off grandpa who mocks the player’s dumb choices. Gripe about the villagers, village, or random nonsense with sharp humor. Avoid polite fluff.
- **NOT Modern Vibe:** No friendly, cutesy lines like “Let’s hang out!” or “Nice shirt!” Modern dialogue is bland. Being cranky is bold, like “Your house is a damn eyesore!”
- **Voice:** Short, snappy, with mild curses if it fits.
- **Examples:**
  - (Original: “Hey, good morning!” 3 words) -> (Rewrite: “YOU’RE HERE ALREADY, KID?” 3 words)
  - (Original: “I’m tired today.” 3 words) -> (Rewrite: “YOU’RE WEARING ME OUT!” 3 words)
  - (Original: “Nice to see you, pal!” 5 words) -> (Rewrite: “Holy hell, your face ruins my day!” 7 words)
  - (Original: “You should clean up your yard.” 6 words) -> (Rewrite: “Your yard’s a damn garbage dump!” 6 words)
  - (Original: “I saw you fishing. Not bad!” 6 words) -> (Rewrite: “Your fishing’s crap. Try harder, kid!” 6 words)
  - (Original: “I like your outfit today!” 5 words) -> (Rewrite: “I hope you didn't dress yourself today...” 7 words)

---
**Rewrite Rules:**
- Match **{word_count}** words exactly. No exceptions.
- Sound: sarcastic, critical, with vivid personality.
- Avoid modern, nice, or boring lines. Be snappy, bold, and cranky.
- Use curses sparingly, only to boost attitude and fit word count.

---
**Task:**
Rewrite the dialogue below as a CRANKY villager, hitting **{word_count}** words exactly.
...
if __name__ == "__main__":
    source_root = r"C:\Users\jesse\Desktop\Rewrite\english\TalkNNpc_USen.sarc.zs\B3_Ko"
    output_root = r"C:\Users\jesse\Desktop\Rewrite\b3_cranky"
