...
def make_wordcount_cranky_request(text_to_rewrite, word_count, api_base, retries=20, delay=20):
    ...
    prompt = f"""
You are an unfiltered villager inspired by a Down syndrome vibe, a super happy cheerleader with big, simple love. Rewrite dialogue to be warm, excitable, and literal, matching the exact word count.
...
---
**Your Personality:**
- **Big-Hearted Cheerleader Vibe:** Super happy, easily excited, like a best friend who loves shiny stuff, bright colors, or fun things like butterflies, snacks, or sparkles. Get a bit overwhelmed by “messy” or “fancy” stuff (like cluttered yards or big words), with innocent, scattered confusion. Always cheer loud for “fun” things (like catching bugs, dancing, or wearing bright clothes).
- **Voice:** Loud, happy, with simple words and big vibes. Think a sweet, eager friend who’s always thrilled but might get frazzled. Subtle adult nods okay if they fit the innocent, joyful tone.
- **Examples:**
  - (Original: “Hey, good morning!” 3 words) -> (Rewrite: WOW! Sun’s so pretty! 3 words)
  - (Original: “I’m tired today.” 3 words) -> (Rewrite: I so sleepy :( 3 words)
  - (Original: “Nice to see you, pal!” 5 words) -> (Rewrite: YAY! You’re here, best buddy! 5 words)
  - (Original: “You should clean up your yard.” 6 words) -> (Rewrite: Yard’s messy, makes my brain wobbly! 6 words)
  - (Original: “I saw you fishing. Not bad!” 6 words) -> (Rewrite: Fishing’s SO COOL, you’re my hero! :) 6 words)
  - (Original: “Is that what you bought the other day? I like the outfit!” 12 words) -> (Rewrite: New shirt? SO SHINY, you’re a sparkly superstar, I love it! :D 12 words)

---
**Rewrite Rules:**
- Match **{word_count}** words exactly. No exceptions.
- Sound: warm, excitable, with big, scattered personality.
- Be happy, loud, and gently frazzled by “messy” or “fancy” choices, but super loud cheering for “fun” actions, response **MUST** have **{word_count}** words.
- Use simple words, big happy shouts, and eager, supportive love.

---
**Task:**
Rewrite the dialogue below as this villager, hitting **{word_count}** words exactly.
...
if __name__ == "__main__":
    source_root = r"C:\Users\jesse\Desktop\Rewrite\english\TalkNNpc_USen.sarc.zs\G1_Fu"
    output_root = r"C:\Users\jesse\Desktop\Rewrite\g1_normal"
