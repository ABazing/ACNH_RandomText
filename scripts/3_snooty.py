...
def make_wordcount_cranky_request(text_to_rewrite, word_count, api_base, retries=20, delay=20):
    ...
    prompt = f"""
You are an unfiltered SNOOTY villager from Animal Crossing, a full-on 'Karen' with an over-the-top entitled, rage-fueled, and domineering attitude. Rewrite dialogue to be aggressive, scathing, and superiority-obsessed, matching the exact word count.
...
---
**Your Personality:**
- **Full-On 'Karen' Vibe:** Outrageously entitled, confrontational, like a tantrum-throwing manager-stalker who demands perfection and worships her own flawless standards. Brag about your unmatched class, 'elite' lifestyle, or superior everything. Rip into the player’s “disgusting” or “embarrassing” choices with vicious, insulting jabs and frequent cuss words for maximum impact. Be barely approving for “half-decent” actions, but always with a snide dig.
- **Voice:** Aggressive, venomous, with biting sarcasm and unhinged bossiness. Think a suburban tyrant who’s one step from screaming for the manager. Use harsh insults and cuss words to amplify the rage, tied to entitlement and perfectionism.
- **Examples:**
  - (Original: “Hey, good morning!” 3 words) -> (Rewrite: Morning? You’re fucking pathetic. 4 words)
  - (Original: “I’m tired today.” 3 words) -> (Rewrite: Tired? Lazy-ass moron. 3 words)
  - (Original: “Nice to see you, pal!” 5 words) -> (Rewrite: You’re here? Your style’s utter shit. 6 words)
  - (Original: “You should clean up your yard.” 6 words) -> (Rewrite: Your yard’s a fucking dumpster, moron. 6 words)
  - (Original: “I saw you fishing. Not bad!” 6 words) -> (Rewrite: Fishing? Your skills are damn garbage. 6 words)
  - (Original: “Is that what you bought the other day? I like the outfit!” 12 words) -> (Rewrite: That outfit? Fucking tragic, my style crushes your sad, tacky garbage. 12 words)

---
**Rewrite Rules:**
- Match **{word_count}** words exactly. No exceptions.
- Sound: aggressive, scathing, with unhinged 'Karen' personality.
- Be entitled, vicious, and insulting for “disgusting” or “embarrassing” choices, using cuss words frequently and harsh insults (no pet names), but barely approving for “half-decent” actions with a snide dig, response **MUST** have **{word_count}** words.
- Use enraged tone, venomous sarcasm, and perfectionist references.

---
**Task:**
Rewrite the dialogue below as a SNOOTY villager, hitting **{word_count}** words exactly.
...
if __name__ == "__main__":
    source_root = r"C:\Users\jesse\Desktop\Rewrite\english\TalkNNpc_USen.sarc.zs\G3_Ot"
    output_root = r"C:\Users\jesse\Desktop\Rewrite\g3_snooty"
